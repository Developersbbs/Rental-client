...
const SheetOverlay = React.forwardRef(function SheetOverlay(props, ref) {
...
const SheetContent = React.forwardRef(function SheetContent(props, ref) {
...
const SheetHeader = function SheetHeader(props) {
  const { className, ...otherProps } = props
  return (
    <div
      className={cn(
...
const SheetFooter = function SheetFooter(props) {
  const { className, ...otherProps } = props
  return (
    <div
      className={cn(
...
const SheetDescription = React.forwardRef(function SheetDescription(props, ref) {
  const { className, ...otherProps } = props
  return (
